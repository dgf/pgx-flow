...
DO $$
  BEGIN
    ...
    INSERT INTO activity (process, name, func  , description           , config) VALUES
      ('parallel.example', 'start'     , 'log' , 'log start data'      , '{"level":"INFO","message":"start parallel example process"}'),
      ('parallel.example', 'gateway1'  , 'log' , 'log gateway branch 1', '{"level":"INFO","message":"parallel gateway branches 1"}'),
      ('parallel.example', 'log1b1g'   , 'log' , 'log branch 1 gate 1' , '{"level":"INFO","message":"parallel log branch 1 gate 1"}'),
      ('parallel.example', 'gateway2'  , 'log' , 'log gateway branch 2', '{"level":"INFO","message":"parallel gateway branches 2"}'),
      ('parallel.example', 'log2b1g'   , 'log' , 'log branch 2 gate 1' , '{"level":"INFO","message":"parallel log branch 2 gate 1"}'),
      ('parallel.example', 'task2b2g'  , 'task', 'create a task'       , '{"group":"staff","subject":"confirm branch 2 gate 2"}'),
      ('parallel.example', 'join2'     , 'log' , 'log join branch 2'   , '{"level":"INFO","message":"join gates of branch 2"}'),
      ('parallel.example', 'join1'     , 'log' , 'log join branch 1'   , '{"level":"INFO","message":"join gates of branch 1"}'),
      ('parallel.example', 'end'       , 'log' , 'log end data'        , '{"level":"INFO","message":"end parallel example process"}');
