...
DO $$
  BEGIN
    ...
    INSERT INTO activity (process, name, func , description   , config) VALUES
      ('condition.example', 'start'    , 'log', 'log start'   , '{"level":"INFO","message":"start conditional example process"}'),
      ('condition.example', 'gateway'  , 'log', 'log gateway' , '{"level":"INFO","message":"gateway branches"}'),
      ('condition.example', 'log1g'    , 'log', 'log gate 1'  , '{"level":"INFO","message":"log gate 1"}'),
      ('condition.example', 'log2g1'   , 'log', 'log gate 2 1', '{"level":"INFO","message":"log gate 2 1"}'),
      ('condition.example', 'log2g2'   , 'log', 'log gate 2 2', '{"level":"INFO","message":"log gate 2 2"}'),
      ('condition.example', 'log3g1'   , 'log', 'log gate 3 1', '{"level":"INFO","message":"log gate 3 1"}'),
      ('condition.example', 'log3g2'   , 'log', 'log gate 3 2', '{"level":"INFO","message":"log gate 3 2"}'),
      ('condition.example', 'log4g'    , 'log', 'log gate 4'  , '{"level":"INFO","message":"log gate 4 1"}'),
      ('condition.example', 'join'     , 'log', 'log join'    , '{"level":"INFO","message":"join gates of branch"}'),
      ('condition.example', 'end'      , 'log', 'log end data', '{"level":"INFO","message":"end conditional example process"}');
